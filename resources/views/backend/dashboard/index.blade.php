                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                {{ $car->where('status', 'tersedia')->get()->count() }} / {{ $car->get()->count() }}
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <a href="{{ route('customer.index') }}" style="text-decoration:none;">
            <div class="card border-left-danger shadow-sm h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Jumlah Pelanggan</div>
        ...
        <a href="{{ route('transaction.index') }}" style="text-decoration:none;">
            <div class="card border-left-danger shadow-sm h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">List Sewa</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
        ...
        <a href="{{ route('transaction.history') }}" style="text-decoration:none;">
            <div class="card border-left-danger shadow-sm h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Riwayat Sewa</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
